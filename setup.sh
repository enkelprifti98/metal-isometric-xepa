...
apk add --no-cache ca-certificates curl openssl sudo xvfb x11vnc xfce4 xfce4-terminal faenza-icon-theme bash procps nano git pciutils xarchiver gzip p7zip cpio tar unzip
